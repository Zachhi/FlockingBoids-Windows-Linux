...
void Boid::updateRotation()
{
	...
	float rotIncVal;
	rotIncVal = currRotationSpeed * rotationSpeedFactor * elapsedRotTime; //this is the value the rotation will increment by everytime it passes the if stmt below
	...
	{
		//if(isPredator)
			//std::cout << elapsedRotTime << std::endl;
